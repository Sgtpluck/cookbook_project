...
class CookbooksControllerTest < ActionController::TestCase
  ...
  test "should create cookbook" do
    assert_difference('Cookbook.count') do
      post :create, cookbook: { description: @cookbook.description, name: @cookbook.name, user_id: @cookbook.user_id }
    end
  ...
  test "should update cookbook" do
    patch :update, id: @cookbook, cookbook: { description: @cookbook.description, name: @cookbook.name, user_id: @cookbook.user_id }
    assert_redirected_to cookbook_path(assigns(:cookbook))
  end
