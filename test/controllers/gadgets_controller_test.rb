...
class GadgetsControllerTest < ActionController::TestCase
  ...
  test "should create gadget" do
    assert_difference('Gadget.count') do
      post :create, gadget: { description: @gadget.description, name: @gadget.name, recipe_id: @gadget.recipe_id }
    end
  ...
  test "should update gadget" do
    patch :update, id: @gadget, gadget: { description: @gadget.description, name: @gadget.name, recipe_id: @gadget.recipe_id }
    assert_redirected_to gadget_path(assigns(:gadget))
  end
